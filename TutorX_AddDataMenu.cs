...
namespace TutorX
{
    public partial class TutorX_AddDataMenu : Form
    {
        ...
        {
            // Sets The TextBoxes To Old Texts
            StudentName_TextBox.Text = "  Student Name:";
            StudentSurname_TextBox.Text = "  Student Surname:";
            StudentBirth_TextBox.Text = "  Student Birth:";
        ...
        {
            // Sets The TextBoxes To Old Texts
            LessonName_TextBox.Text = "  Lesson Name:";
        ...
        {
            // Sets The TextBoxes To Old Texts
            TeacherName_TextBox.Text = "  Teacher Name:";
            TeacherSurname_TextBox.Text = "  Teacher Surname:";
            TeacherBirth_TextBox.Text = "  Teacher Birth:";
            TeacherField_TextBox.Text = "  Teacher Field:";
